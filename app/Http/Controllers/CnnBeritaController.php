...
class CnnBeritaController extends Controller
{
    public function indexCnn(Request $request, $kategori = 'terbaru')
    {
        $validCategories = [
        ...
        return view('front.cnnindo', compact('berita'));
    }

    public function downloadCsvcnn(Request $request)
    {
        $validCategories = [
            'terbaru', 'politik', 'hukum', 'ekonomi', 'bola', 'olahraga', 
            'humaniora', 'lifestyle', 'hiburan', 'dunia', 'tekno', 'otomotif'
        ...
        $fileName = "berita_semua_kategori_antara.csv";
